...
function Footer() {
  ...
  <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
        ...
        <div className="cardFooterc">
        <h2>Download Our App</h2>
        <div className="footerimage">
        <img src={Apple} alt="applestore link" srcSet="" />
        <img src={Android} alt="play store link" srcSet="" />
        </div>
        </div>
      </div>
      <hr className='hr'></hr>
      <div className="copyright">
        <p>Copyright © 2024 Cnex. All rights reserved. Powered by: Sudip Khadka ---Vrit Tech    </p>
      </div>
    </div>
  )
}
